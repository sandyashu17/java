...
// i/p: seqinput.txt
//hadoop jar wcount.jar BinaryFilesToHadoopSequenceFile /niit/seqinput.txt /niit1/output1
...
public class BinaryFilesToHadoopSequenceFile {
	...
	public static class BinaryFilesToHadoopSequenceFileMapper extends Mapper<LongWritable, Text, Text, BytesWritable> {
...
//			System.exit(2);
//		}
	    Job job = Job.getInstance(conf, "BinaryFilesToHadoopSequenceFile");
