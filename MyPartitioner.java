//i/p: emp.csv
//hadoop jar emp.jar MyPartitioner /niit/emp.csv /niit/parti
//to find Top Salaried Employees(partitioner)
...
//        	outputKey.set(key);
   ...
   {
      ToolRunner.run(new Configuration(), new MyPartitioner(),ar);//execute your code using toolrunner.run
      System.exit(0);
   }
}